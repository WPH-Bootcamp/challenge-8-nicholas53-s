...
```
Nama: [Nicholas]
Repository: [https://github.com/nicholas53-s/challenge-8-nicholas53-s.git]
Deployment: [https://challenge-8-nicholas53-s-n7bl.vercel.app]
Notes: [Sempat memngalami error deploy karena berbeda huruf capital folder]
```
